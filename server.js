...
// Форма "цены"
 ...
 // User.insertOne(user, function(err, result) {
        ...
        //     const db = client.db("WebOKA");// директория базы данных
        //     const collection = db.collection("User"); // передача в коллекцию
            
        //     //  mongoose.connect("mongodb://localhost:27017/(userName)", { useNewUrlParser: true });
  
        //     //  const UserTable = mongoose.model("UserTable", userScheme);
 ...
 //     mongoClient.connect(function(err, client, body){
        ...
        //       const db = client.db("WebOKA");// директория базы данных
        //       const collection = db.collection(userName); // передача в коллекцию
        //     var proverka = {}
        //     if(collection === userName){  // проверка данных для логина
        //         console.log("Готово!")
        //    }else{
